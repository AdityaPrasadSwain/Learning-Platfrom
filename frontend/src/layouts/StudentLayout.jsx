...
import {
    ...
    FileQuestion, LogOut, Menu, X, UserCircle, PlayCircle
} from 'lucide-react';
    ...
    return (
        <div className="relative flex h-screen">
            ...
            <aside
                ...
                style={{ background: 'rgba(8, 10, 22, 0.88)', backdropFilter: 'blur(24px)' }}
            >
                {/* Brand */}
            ...
            <div className="relative z-10 flex-1 flex flex-col overflow-hidden">
                ...
                <header
                    ...
                    style={{ background: 'rgba(8,10,22,0.88)', backdropFilter: 'blur(20px)' }}
                >
