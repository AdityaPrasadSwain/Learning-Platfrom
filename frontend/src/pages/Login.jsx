...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            Swal.close();
            await showSuccess('Welcome Back!', `Logged in as ${response.data.username}`);
            navigate('/dashboard');
        } catch (error) {
        ...
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 bg-white/90 dark:bg-black/80 backdrop-blur-md border border-gray-200 dark:border-gray-700 p-8 w-full max-w-md animate-float rounded-2xl shadow-xl">
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-gradient-to-r from-brand-primary to-brand-secondary text-white font-bold py-3.5 px-4 rounded-full hover:shadow-lg hover:shadow-brand-primary/20 hover:scale-[1.02] transition-all duration-300"
                    >
                        Sign In
                    </button>
                ...
                <div className="mt-6 text-center">
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <Link to="/register" className="text-brand-secondary hover:text-brand-primary font-semibold transition-colors">
                            Register here
                        </Link>
                    </p>
                </div>
