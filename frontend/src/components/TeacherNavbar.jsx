...
import { LogOut, User, Bell, Search, Settings, Shield } from 'lucide-react';
            ...
            <div className="max-w-[1600px] mx-auto flex justify-between items-center">
                ...
                <div className="flex items-center gap-8">
                    <Link to="/teacher/dashboard" className="flex items-center gap-3 group">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[10px] font-bold text-purple-500 tracking-[0.2em] uppercase mt-1">Instructor Hub</span>
                        </div>
                    </Link>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="hidden md:flex items-center relative group">
                        <Search className="absolute left-3 w-4 h-4 text-slate-400 group-focus-within:text-purple-500 transition-colors" />
                        <input 
                            type="text" 
                            placeholder="Search courses..." 
                            className="bg-slate-100 dark:bg-slate-800/50 border border-transparent focus:border-purple-500/50 rounded-xl py-2 pl-10 pr-4 text-sm text-slate-900 dark:text-white w-64 transition-all focus:w-80 outline-none"
                        />
                    </div>
                    ...
                    <div className="relative">
                        ...
                        >
                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center text-white text-sm font-bold shadow-lg group-hover:ring-4 ring-purple-500/20 transition-all">
                                    ...
                                    >
                                        <div className="p-5 border-b border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-white/[0.02]">
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 rounded-xl bg-purple-500 flex items-center justify-center text-white font-bold">
                                                    {username.charAt(0).toUpperCase()}
                                                </div>
                                                <div className="min-w-0">
                                                    <p className="text-sm font-bold text-slate-900 dark:text-white truncate">{username}</p>
                                                    <p className="text-[10px] text-purple-500 font-bold uppercase tracking-wider mt-0.5">Faculty Member</p>
                                                </div>
                                            </div>
                                        </div>
