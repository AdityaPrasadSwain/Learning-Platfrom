...
public class DatabaseConstraintFixer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            ...
            System.out.println("✅ Database constraints successfully updated to ON DELETE CASCADE.");
        } catch (Exception e) {
            System.err.println("⚠️ Failed to update database constraints: " + e.getMessage());
        }
    }
}
